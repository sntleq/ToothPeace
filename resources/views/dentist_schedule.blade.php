...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="{{ route('dentist.schedule') }}" class="active"><img src="{{ asset('pics/appointment_icon.png') }}" alt="Appointments">Appointments</a>
    </nav>
    ...
    <div class="main-container">
        ...
        <div class="appointment-buttons-wrapper">
            <button class="appointment-history-btn"
                    onclick="window.location.href='{{ route('dentist.schedule.history') }}'">
