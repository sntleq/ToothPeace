...
<body>
  <div class="sidebar">
    ...
    <nav>
      <a href="/patient/Profile" class="active"><img src="{{ asset('pics/patient_profile_icon.png') }}" alt="Home">Home</a>
      <a href="/patient/Appointments"><img src="{{ asset('pics/appointment_icon.png') }}" alt="Appointments">Appointments</a>
      <a href="/patientWaitlist"><img src="{{ asset('pics/waitlist_entry_icon.png') }}" alt="Waitlist Entry">Waitlist Entry</a>
    </nav>
