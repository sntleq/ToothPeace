...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin_dentists.css') }}"/>
</head>
<body>
<div class="sidebar">
    <div class="logo">
    ...
    <nav>
        ...
        <a href="{{ route ('admin.controls') }}"><img src="{{ asset('pics/admincontrols_icon.png') }}" alt="Admin Controls">Controls</a>
    </nav>
...
<script src="{{ asset('js/admin_dentists.js') }}"></script>
