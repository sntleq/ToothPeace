    ...
    <div class="form-container services-container">
        <form action="#">
            ...
            <div class="buttons" id="serviceButtons">
                <button type="button" class="ghost" id="service1"
                        onclick="showService('content1', 'pics/dental_appointments.png')">Dental Appointments
                </button>
                <button type="button" class="ghost" id="service2"
                        onclick="showService('content2', 'pics/restorative_treatment.png')">Restorative Treatments
                </button>
                <button type="button" class="ghost" id="service3"
                        onclick="showService('content3', 'pics/preventive_treatments.png')">Preventive Treatments
                </button>
                <button type="button" class="ghost" id="service4"
                        onclick="showService('content4', 'pics/cosmetic_dentistry.png')">Cosmetic Dentistry
                </button>
                <button type="button" class="ghost" id="service5"
                        onclick="showService('content5', 'pics/orthodontics.png')">Orthodontics
                </button>
                <button type="button" class="ghost" id="service6"
                        onclick="showService('content6', 'pics/oral_surgery.png')">Oral Surgery
                </button>
                <button type="button" class="ghost" id="service7"
                        onclick="showService('content7', 'pics/pediatric_dentistry.png')">Pediatric Dentistry
                </button>
                <button type="button" class="ghost" id="service8"
                        onclick="showService('content8', 'pics/periodontics.png')">Periodontics
                </button>
                <button type="button" class="ghost" id="service9"
                        onclick="showService('content9', 'pics/emergency_dentistry.png')">Emergency Dentistry
                </button>
            </div>
        </form>
    </div>
